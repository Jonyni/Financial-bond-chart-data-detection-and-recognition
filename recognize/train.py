...
parser.add_argument('--eval_list', type=str, default='test.txt',help='path to evalation dataset list file')
    ...
    for epoch in range(cfg.num_epochs):
        ...
        for i in range(len(train_loader)):
            ...
            if i % 10 == 0:
                ...
                logger.scalar_summary('Loss of Epoch{0}/miniBatch(100)'.format(epoch), loss_avg.val(), i)
                logger.scalar_summary('Loss of Epoch/miniBatch(100)', loss_avg.val(), epoch*len(train_loader)+i)
                loss_avg.reset()
